  ...
  constructor() {
    ...
    _defineProperty(this, "init", async () => {
      ...
      if (this.options.enableSlider) {
        ...
        load_assets_loadCSS((_window = window) === null || _window === void 0 ? void 0 : _window.themeStyleURLs.swiper.url);
        load_assets_loadJS((_window2 = window) === null || _window2 === void 0 ? void 0 : _window2.themeScriptURLs.swiper.url);
      }
      ...
      if (this.products.length) {
        ...
        (_window$spratlyTheme = window.spratlyTheme) === null || _window$spratlyTheme === void 0 ? void 0 : (_window$spratlyTheme$ = _window$spratlyTheme.Products) === null || _window$spratlyTheme$ === void 0 ? void 0 : _window$spratlyTheme$.initProductForms({
          ...
          var _window3, _window3$spratlyTheme, _window3$spratlyTheme2, _window4, _window4$spratlyTheme, _window4$spratlyTheme2;

          this.initByScreenSize();
          window.addEventListener('resize', debounce(this.initByScreenSize));
          (_window3 = window) === null || _window3 === void 0 ? void 0 : (_window3$spratlyTheme = _window3.spratlyTheme) === null || _window3$spratlyTheme === void 0 ? void 0 : (_window3$spratlyTheme2 = _window3$spratlyTheme.CompareProduct) === null || _window3$spratlyTheme2 === void 0 ? void 0 : _window3$spratlyTheme2.setCompareButtonsState();
          (_window4 = window) === null || _window4 === void 0 ? void 0 : (_window4$spratlyTheme = _window4.spratlyTheme) === null || _window4$spratlyTheme === void 0 ? void 0 : (_window4$spratlyTheme2 = _window4$spratlyTheme.Wishlist) === null || _window4$spratlyTheme2 === void 0 ? void 0 : _window4$spratlyTheme2.setWishlistButtonsState();
    ...
    _defineProperty(this, "initProductCountdown", () => {
      var _window5, _window5$themeScriptU, _window5$themeScriptU2;

      load_assets_loadJS((_window5 = window) === null || _window5 === void 0 ? void 0 : (_window5$themeScriptU = _window5.themeScriptURLs) === null || _window5$themeScriptU === void 0 ? void 0 : (_window5$themeScriptU2 = _window5$themeScriptU.countdown) === null || _window5$themeScriptU2 === void 0 ? void 0 : _window5$themeScriptU2.url).then(() => {
        var _window6, _window6$spratlyTheme, _window6$spratlyTheme2, _window6$spratlyTheme3;

        (_window6 = window) === null || _window6 === void 0 ? void 0 : (_window6$spratlyTheme = _window6.spratlyTheme) === null || _window6$spratlyTheme === void 0 ? void 0 : (_window6$spratlyTheme2 = _window6$spratlyTheme.ProductCountdown) === null || _window6$spratlyTheme2 === void 0 ? void 0 : (_window6$spratlyTheme3 = _window6$spratlyTheme2.init) === null || _window6$spratlyTheme3 === void 0 ? void 0 : _window6$spratlyTheme3.call(_window6$spratlyTheme2);
      });
    });
