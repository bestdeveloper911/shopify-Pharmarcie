...
const formatTitle = discount => {
  var _window$Shopify, _window$Shopify$curre, _window, _window$spratlyThemeS;

  const value = discount.type === 'PERCENTAGE' ? `${discount === null || discount === void 0 ? void 0 : discount.value}%` : currency_formatMoney((discount === null || discount === void 0 ? void 0 : discount.value) * 100 * Number(((_window$Shopify = window.Shopify) === null || _window$Shopify === void 0 ? void 0 : (_window$Shopify$curre = _window$Shopify.currency) === null || _window$Shopify$curre === void 0 ? void 0 : _window$Shopify$curre.rate) || 1), (_window = window) === null || _window === void 0 ? void 0 : (_window$spratlyThemeS = _window.spratlyThemeSettings) === null || _window$spratlyThemeS === void 0 ? void 0 : _window$spratlyThemeS.money_format);
  ...
  constructor(settings) {
    ...
    (0,defineProperty/* default */.Z)(this, "listenEvents", () => {
      ...
      (_window3 = window) === null || _window3 === void 0 ? void 0 : (_window3$_ThemeEvent = _window3._ThemeEvent) === null || _window3$_ThemeEvent === void 0 ? void 0 : (_window3$_ThemeEvent$ = _window3$_ThemeEvent.subscribe) === null || _window3$_ThemeEvent$ === void 0 ? void 0 : _window3$_ThemeEvent$.call(_window3$_ThemeEvent, 'ON_ITEM_ADDED', async cart => {
        console.log(cart, 'cart json ON_CART_UPDATE');
    ...
    (0,defineProperty/* default */.Z)(this, "updateButtonStatus", async cartItems => {
      ...
      (_this$settings3 = this.settings) === null || _this$settings3 === void 0 ? void 0 : (_this$settings3$disco = _this$settings3.discounts) === null || _this$settings3$disco === void 0 ? void 0 : _this$settings3$disco.map((discount, index) => {
        console.log(this.totalAdded, discount.min_qty, 'totalAdded');
    ...
    (0,defineProperty/* default */.Z)(this, "toggleSpinner", (target, status) => {
      ...
      console.log(this.domNodes.productList, 'this.domNodes.productList');
